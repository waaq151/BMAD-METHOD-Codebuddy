...
/**
 * Codebuddy IDE setup handler
 */
class CodebuddySetup extends BaseIdeSetup {
  constructor() {
    super('codebuddy', 'Codebuddy', true); // preferred IDE
    this.configDir = '.codebuddy';
    this.rulesDir = 'rules';
  }
  ...
  /**
   * Setup Codebuddy IDE configuration
   * @param {string} projectDir - Project directory
  ...
  async setup(projectDir, bmadDir, options = {}) {
    ...
    // Create .codebuddy/rules directory structure
    const codebuddyDir = path.join(projectDir, this.configDir);
    const rulesDir = path.join(codebuddyDir, this.rulesDir);
...
# BMAD Method - Codebuddy Rules Index

This is the master index for all BMAD agents, tasks, tools, and workflows available in your project.

## Installation Complete!

BMAD rules have been installed to: \`.codebuddy/rules/bmad/\`

**Note:** BMAD does not modify your \`.codebuddyrules\` file. You manage that separately.
...
`;
  ...
  /**
   * Override processContent to add MDC metadata header for Codebuddy
